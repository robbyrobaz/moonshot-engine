#!/usr/bin/env python3
"""Insert 2026-04-04 Moonshot Scout variants into tournament queue."""
...
CONFIG_DIR = Path(__file__).parent / "configs" / "generated" / "2026-04-04"
...
def main():
    ...
    for config_path in config_files:
        try:
            ...
            print(f"   {cfg['direction']:5s} | {cfg['model_type']:10s} | {len(cfg['feature_set'])} features")
